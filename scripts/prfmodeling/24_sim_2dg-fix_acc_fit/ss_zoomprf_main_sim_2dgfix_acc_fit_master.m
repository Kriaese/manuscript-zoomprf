%% -----------------------------------------------------------------------------
% 24 - zoomprf main - simulate - 2dg-fix model - accuracy - fitting
% ------------------------------------------------------------------------------
%
%
% ------------------------------------------------------------------------------
...
Files.Sim               = {'task-prf_nrep-' '_sd-' '_2dg-fix_aperture-pins_vec_spmcan'};
...
try
    ...
    %% -------------------------------------------------------------------------
    % (1) Simulate - 2dg-fix model - accuracy - fitting
    % --------------------------------------------------------------------------
