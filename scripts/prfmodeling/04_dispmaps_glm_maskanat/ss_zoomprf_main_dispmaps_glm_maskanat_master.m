%% -----------------------------------------------------------------------------
% 04 - zoomprf main - display t-map from glm with masked anatomy
% ------------------------------------------------------------------------------
%
%
% ------------------------------------------------------------------------------
% 18/09/2022: Generated (SS)
...
Files.Data               = '*mgh2srf_spmcan_glm_conts.mat';
Files.FSLabel            = {'.BA3b_exvivo.thresh'};
Files.SamSrfLabel        = {'D2a'};
Files.FSAtlas            = [];

Files.AnatLabel          = {'.postcentral' 'fsatlas'};
...
try
    ...
    %% -------------------------------------------------------------------------
    % (1) Display t-map from glm with masked anatomy
    % --------------------------------------------------------------------------
