function preproc_pRF(data, spmpath)
...
% Falk Luesebrink (2022) 
% Susanne Stoll (18.04.2024)
% Susanne Stoll (24.04.2024)
...
param.path    = fullfile(spmpath, 'tpm', 'TPM.nii'); % Set path to tissue probability model
param.fwhm    = 15;        % FWHM (default: 60)
